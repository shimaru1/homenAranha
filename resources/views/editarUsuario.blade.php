...
<table class="table">
  ...
  <tbody>
    @foreach($registrosUsuario as $registrosUsuario)
    <tr>
      <th scope="row">{{$registrosUsuario->id}}</th>
      <td>{{$registrosUsuario->usuario}}</td>
      <td>{{$registrosUsuario->senha}}</td>
      <td>{{$registrosUsuario->email}}</td>
      <td>
        <a href="{{route('alterar-Usuario',$registrosUsuario->id)}}">
